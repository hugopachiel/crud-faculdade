...
<body>
    ...
    padding: 24px;">
        ...
        <a class="nav-item nav-link" href="https://www.gov.br/fale-conosco">CONTATO TI</a>
        <a class="nav-item nav-link" href="https://www.canalti.com.br/">SITE</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="create.php" class="btn btn-primary"><i class="fa fa-plus" ></i> Adicione um novo empregado!</a>
                    </div>
                    <?php
                    // Include config file
